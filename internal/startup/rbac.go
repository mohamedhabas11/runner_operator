...
var expectedPerms = []permission{
	...
	{"runners.runners.runner-operator.io", "eventtriggers", "create"},
	{"runners.runners.runner-operator.io", "eventtriggers", "delete"},
	{"runners.runners.runner-operator.io", "eventtriggers", "get"},
	{"runners.runners.runner-operator.io", "eventtriggers", "list"},
	{"runners.runners.runner-operator.io", "eventtriggers", "patch"},
	{"runners.runners.runner-operator.io", "eventtriggers", "update"},
	{"runners.runners.runner-operator.io", "eventtriggers", "watch"},
	{"runners.runners.runner-operator.io", "eventtriggers/status", "get"},
	{"runners.runners.runner-operator.io", "eventtriggers/status", "patch"},
	{"runners.runners.runner-operator.io", "eventtriggers/status", "update"},
	{"runners.runners.runner-operator.io", "runners", "create"},
	{"runners.runners.runner-operator.io", "runners", "delete"},
	{"runners.runners.runner-operator.io", "runners", "get"},
	{"runners.runners.runner-operator.io", "runners", "list"},
	{"runners.runners.runner-operator.io", "runners", "patch"},
	{"runners.runners.runner-operator.io", "runners", "update"},
	{"runners.runners.runner-operator.io", "runners", "watch"},
	{"runners.runners.runner-operator.io", "runners/status", "get"},
	{"runners.runners.runner-operator.io", "runners/status", "patch"},
	{"runners.runners.runner-operator.io", "runners/status", "update"},
	{"runners.runners.runner-operator.io", "workflows", "create"},
	{"runners.runners.runner-operator.io", "workflows", "delete"},
	{"runners.runners.runner-operator.io", "workflows", "get"},
	{"runners.runners.runner-operator.io", "workflows", "list"},
	{"runners.runners.runner-operator.io", "workflows", "patch"},
	{"runners.runners.runner-operator.io", "workflows", "update"},
	{"runners.runners.runner-operator.io", "workflows", "watch"},
	{"runners.runners.runner-operator.io", "workflows/status", "get"},
	{"runners.runners.runner-operator.io", "workflows/status", "patch"},
	{"runners.runners.runner-operator.io", "workflows/status", "update"},
}
