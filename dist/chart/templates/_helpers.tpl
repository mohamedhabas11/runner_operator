...
*/}}
{{- define "runner-operator.fullname" -}}
...
*/}}
{{- define "runner-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "runner-operator.resourceName" -}}
{{- $fullname := include "runner-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "runner-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "runner-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
