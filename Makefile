...
KIND_CLUSTER ?= runner-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name runner-operator-builder
	$(CONTAINER_TOOL) buildx use runner-operator-builder
...
HELM_NAMESPACE ?= runner-operator-system
## Name of the Helm release
HELM_RELEASE ?= runner-operator
